...
public class PipeSourceConstant {
  ...
  public static final String EXTRACTOR_HISTORY_TSFILE_ORDER_BY_FLUSH_TIME_KEY =
      "extractor.history.tsfile.order-by-flush-time";
  public static final String SOURCE_HISTORY_TSFILE_ORDER_BY_FLUSH_TIME_KEY =
      "source.history.tsfile.order-by-flush-time";
  public static final boolean EXTRACTOR_HISTORY_TSFILE_ORDER_BY_FLUSH_TIME_DEFAULT_VALUE = true;
