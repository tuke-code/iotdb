...
public final class ConfigNodeMessages {
  ...
  public static final String MESSAGE_CAPACITY_ARG_REQUESTED_TOTAL_ARG_PLEASE_DELETE_SOME_EXISTING_RULES_35B24B22 = "（容量：%d，请求总数：%d）。请先删除一些已有规则。";
  public static final String LOG_EXITS_JVM_MEMORY_USAGE_ARG_0BCD1CCF = " 退出。JVM 内存使用情况：{}";
  public static final String EXCEPTION_TOPOLOGY_PROBING_BASE_INTERVAL_MS_MUST_POSITIVE_BUT_GOT_18C9B7A2 = "topology_probing_base_interval_in_ms 必须为正数，实际为：";
  public static final String EXCEPTION_TOPOLOGY_PROBING_TIMEOUT_RATIO_MUST_0_1_BUT_GOT_FBD0E28B = "topology_probing_timeout_ratio 必须在 (0, 1) 范围内，实际为：";
  ...
  public static final String EXCEPTION_PLEASE_DELETE_DATA_DIR_DATA_CONFIGNODE_RESTART_AGAIN_8527BE66 = "请删除数据目录 data/confignode 后重新启动。";
  public static final String EXCEPTION_CONFIG_NODE_CONSENSUS_PROTOCOL_CLASS_SET_E7A83ED6 = "config_node_consensus_protocol_class 被设置为";
  public static final String EXCEPTION_AVAILABLE_ONLY_SCHEMA_REPLICATION_FACTOR_SET_1_45667207 = "仅在 schema_replication_factor 设置为 1 时可用";
  public static final String EXCEPTION_MESSAGE_E81C4E4F = "或";
  public static final String EXCEPTION_AVAILABLE_ONLY_DATA_REPLICATION_FACTOR_SET_1_71748D3D = "仅在 data_replication_factor 设置为 1 时可用";
  public static final String EXCEPTION_ARG_ARG_6E068B23 = "%s 或 %s";
  public static final String EXCEPTION_SCHEMAREGION_DOESN_T_SUPPORT_ORG_APACHE_IOTDB_CONSENSUS_IOT_IOTCONSENSUS_84350FD1 = "SchemaRegion 不支持 org.apache.iotdb.consensus.iot.IoTConsensus";
  public static final String EXCEPTION_SCHEMAREGION_DOESN_T_SUPPORT_ORG_APACHE_IOTDB_CONSENSUS_IOT_IOTCONSENSUSV2_BA353C6D = "SchemaRegion 不支持 org.apache.iotdb.consensus.iot.IoTConsensusV2";
  public static final String EXCEPTION_GREEDY_MIN_COST_FLOW_HASH_C07DA2EE = "GREEDY、MIN_COST_FLOW 或 HASH";
  public static final String EXCEPTION_UNRECOGNIZED_LEADER_DISTRIBUTION_POLICY_SET_F9FFB410 = "设置了无法识别的 leader_distribution_policy";
  public static final String EXCEPTION_LEADER_GREEDY_55C6B994 = "LEADER 或 GREEDY";
  public static final String EXCEPTION_UNRECOGNIZED_ROUTE_PRIORITY_POLICY_SET_C0012AE4 = "设置了无法识别的 route_priority_policy";
  public static final String EXCEPTION_THERE_NO_AVAILABLE_ARG_DATABASES_ARG_CURRENTLY_9B8297B3 = "当前数据库 %s 没有可用的 %s，";
  public static final String EXCEPTION_PLEASE_USE_SHOW_CLUSTER_SHOW_REGIONS_CHECK_CLUSTER_STATUS_611120DF = "请使用 \"show cluster\" 或 \"show regions\" 检查集群状态";
  ...
  public static final String EXCEPTION_DATANODE_NOT_ENOUGH_PLEASE_REGISTER_MORE_9F5EEDF5 = "DataNode 数量不足，请注册更多 DataNode。";
  public static final String EXCEPTION_CURRENT_DATANODES_ARG_REPLICATIONFACTOR_ARG_5D686D2B = "当前 DataNode: %s, replicationFactor: %d";
  public static final String EXCEPTION_THERE_NO_AVAILABLE_AINODES_CURRENTLY_PLEASE_USE_SHOW_CLUSTER_CHECK_FD32EB52 = "当前没有可用的 AINode，请使用 \"show cluster\" 检查集群状态。";
  public static final String EXCEPTION_ADD_CONSENSUSGROUP_ARG_FAILED_D3FDDC1B = "向 %s 添加 ConsensusGroup 失败。";
  ...
  public static final String LOG_REDIRECTION_RECOMMENDED_REMOVECONFIGNODE_BUT_NO_LEADER_ENDPOINT_PROVIDED_ABORT_RETRY_520A4C64 = "removeConfigNode 建议重定向，但未提供 leader 端点，终止重试。";
  public static final String LOG_FAILED_WRITE_AUDIT_LOG_DATANODE_ARG_RESPONSE_ARG_691ABC90 = "向 DataNode {} 写入审计日志失败，响应：{}";
  public static final String LOG_FAILED_WRITE_AUDIT_LOG_DATANODE_ARG_90F15E13 = "向 DataNode {} 写入审计日志失败";
  public static final String EXCEPTION_UNKNOWN_PHYSICALPLANTYPE_ARG_7F21B699 = "未知的 PhysicalPlanType: %d";
  public static final String LOG_CANNOT_READ_MORE_PHYSICALPLANS_ARG_SUCCESSFULLY_READ_INDEX_ARG_REASON_2EC90E78 = "无法从 {} 读取更多 PhysicalPlans，已成功读取的索引为 {}。原因是";
  ...
  public static final String LOG_CANNOT_DESERIALIZE_PHYSICALPLANS_BYTEBUFFER_IGNORE_REMAINING_LOGS_06AE778F = "无法从 ByteBuffer 反序列化 PhysicalPlans，忽略剩余日志";
  public static final String MESSAGE_FAILED_ALTER_DATABASE_DOESN_T_SUPPORT_ALTER_SCHEMAREPLICATIONFACTOR_YET_AD96111F = "修改数据库失败。暂不支持 ALTER SchemaReplicationFactor。";
  public static final String MESSAGE_FAILED_ALTER_DATABASE_DOESN_T_SUPPORT_ALTER_DATAREPLICATIONFACTOR_YET_2E7FF6E7 = "修改数据库失败。暂不支持 ALTER DataReplicationFactor。";
  public static final String MESSAGE_FAILED_ALTER_DATABASE_DOESN_T_SUPPORT_ALTER_TIMEPARTITIONORIGIN_YET_B315F2E3 = "修改数据库失败。暂不支持 ALTER TimePartitionOrigin。";
  public static final String MESSAGE_FAILED_ALTER_DATABASE_DOESN_T_SUPPORT_ALTER_TIMEPARTITIONINTERVAL_YET_F539A76F = "修改数据库失败。暂不支持 ALTER TimePartitionInterval。";
  public static final String MESSAGE_REMOVE_CONSENSUSGROUP_FAILED_BECAUSE_TARGET_CONFIGNODE_NOT_CURRENT_CONFIGNODE_608E64F9 = "移除 ConsensusGroup 失败，原因：目标 ConfigNode 不是当前 ConfigNode。";
  public static final String MESSAGE_REMOVE_CONSENSUSGROUP_FAILED_BECAUSE_INTERNAL_FAILURE_SEE_OTHER_LOGS_MORE_51858EC2 = "移除 ConsensusGroup 失败，原因：内部错误。更多详情请查看其他日志";
  public static final String EXCEPTION_LOADPIPETASKINFOEXCEPTION_2270468E = "加载 PipeTaskInfo 异常=";
  public static final String EXCEPTION_LOADPIPEPLUGININFOEXCEPTION_40362E11 = ", 加载 PipePluginInfo 异常=";
  public static final String MESSAGE_FAILED_SET_PIPE_STATUS_STOPPED_RUNTIME_EXCEPTION_FLAG_BECAUSE_BFEA15AA = "设置 pipe 状态及运行时异常停止标记失败，原因：";
  ...
  public static final String LOG_HANDLING_COMMIT_PROGRESS_META_CHANGES_FA21A080 = "正在处理提交进度元数据变更 ...";
  public static final String EXCEPTION_FAILED_CREATE_ALTER_TOPIC_ILLEGAL_ARG_ARG_EXPECTED_1_POSITIVE_A33070FB = "创建或修改 topic 失败，非法参数 %s=%s，期望为 -1 或正 long 值";
  public static final String LOG_TRYING_GET_MAX_TTL_UNDER_ONE_DATABASE_USE_LONG_MAX_9D70ACB2 = " 尝试获取单个数据库下的最大 ttl 时，使用 Long.MAX_VALUE。";
  public static final String MESSAGE_ENABLE_IOTDB_CLUSTER_S_DATA_SERVICE_PLEASE_REGISTER_ARG_MORE_F48F3890 = "要启用 IoTDB-Cluster 的数据服务，请再注册 %d 个 IoTDB-DataNode";
  public static final String MESSAGE_APPLY_NEW_CONFIGNODE_FAILED_BECAUSE_CURRENT_CONFIGNODE_CAN_T_STORE_1BB6A6BF = "应用新 ConfigNode 失败，原因：当前 ConfigNode 无法存储 ConfigNode 信息。";
  public static final String MESSAGE_REMOVE_CONFIGNODE_FAILED_BECAUSE_CURRENT_CONFIGNODE_CAN_T_STORE_CONFIGNODE_8AB3BCB4 = "移除 ConfigNode 失败，原因：当前 ConfigNode 无法存储 ConfigNode 信息。";
  public static final String LOG_NODE_ARG_REGION_ARG_70A7CD4F = "节点: {}, Region: {}";
  public static final String LOG_NO_NEED_REMOVE_IT_NODE_ARG_REGION_ARG_D14062CE = "无需移除，节点：{}，Region：{}";
  public static final String LOG_PID_ARG_FAILED_WRITE_UPDATE_API_EXECUTING_CONSENSUS_LAYER_824FB30E = "pid={} 执行共识层写入更新 API 失败，原因：";
  public static final String LOG_PID_ARG_FAILED_WRITE_DELETE_API_EXECUTING_CONSENSUS_LAYER_0E758BF5 = "pid={} 执行共识层写入删除 API 失败，原因：";
  ...
  public static final String LOG_ALL_SERVICES_OLD_LEADER_UNAVAILABLE_NOW_8A22E60F = "旧 leader 上的所有服务现在均不可用。";
